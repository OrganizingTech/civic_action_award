...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference("Leaderboard.count") do
      post leaderboards_url, params: { leaderboard: { description: @leaderboard.description, title: @leaderboard.title } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { description: @leaderboard.description, title: @leaderboard.title } }
